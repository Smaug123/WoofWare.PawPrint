...
Then invoke OpenAI Codex to perform a review of your work, and address any of its findings that you think are appropriate: `~/.local/bin/codex -p nix-review review --base main` (this can take many minutes, and produces a huge amount of text, so redirect output to a file).
