...
module TestNullaryIlOp =
    ...
    let private negCaseValues (case : NegCase) : EvalStackValue * EvalStackValue =
        ...
        | NegCase.Int64Value value -> EvalStackValue.ofInt64 value, EvalStackValue.ofInt64 (expectedNegInt64 value)
    ...
    [<Test>]
    let ``Conv_U8 preserves managed pointer provenance as tagged int64`` () : unit =
