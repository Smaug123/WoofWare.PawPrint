...
// `newobj` naming a reflected `ConstructorInfo` emits and mints, but PawPrint's decoder refuses
// `newobj` in a dynamic body outright (measured; on real .NET this shape constructs the object) -- so
