...
//
// errno is read via Marshal.GetLastSystemError rather than
// GetLastPInvokeError: with a raw DllImport there is no generated stub to copy
// one to the other, so the latter would report a stale value.
//
