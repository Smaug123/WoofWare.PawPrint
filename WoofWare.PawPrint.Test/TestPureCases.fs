...
module TestPureCases =
    ...
    let unimplemented =
        [
            ...
            "NullDereferenceTest.cs" // past QCall ModuleHandle::ResolveMethod; now blocked during ArgumentException ctor → ResourceManager init by unimplemented InternalCall RuntimeMethodHandle::GetLoaderAllocatorInternal
            ...
            "MakeGenericTypeStructConstraint.cs" // past QCall ModuleHandle::ResolveMethod; now blocked during ArgumentException ctor → ResourceManager init by unimplemented InternalCall RuntimeMethodHandle::GetLoaderAllocatorInternal
            "MakeGenericTypeClassConstraint.cs" // past QCall ModuleHandle::ResolveMethod; now blocked during ArgumentException ctor → ResourceManager init by unimplemented InternalCall RuntimeMethodHandle::GetLoaderAllocatorInternal
            "MakeGenericTypeNewConstraint.cs" // past QCall ModuleHandle::ResolveMethod; now blocked during ArgumentException ctor → ResourceManager init by unimplemented InternalCall RuntimeMethodHandle::GetLoaderAllocatorInternal
