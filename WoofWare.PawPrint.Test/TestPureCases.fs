...
module TestPureCases =
    ...
    let unimplemented =
        [
            ...
            "Threads.cs" // past Interlocked.MemoryBarrier now that the intrinsic is a no-op; next blocker is the unimplemented ClrConfig_GetConfigBoolValue QCall reached via AutoreleasePool.EnableAutoreleasePool's static-field initialiser when a thread starts (CoreCLR's CLRConfig.GetBoolValue path; src/coreclr/System.Private.CoreLib/src/System/CLRConfig.cs:18)
