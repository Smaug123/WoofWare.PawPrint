...
module TestPureCases =
    ...
    let unimplemented =
        [
            ...
            "NullDereferenceTest.cs" // past CastCacheEntry byte-view read through `[ReinterpretAs CastCacheEntry, Field _version, ReinterpretAs VolatileUInt32]`; now blocked by unimplemented QCall TypeHandle::CanCastTo_NoCacheLookup
