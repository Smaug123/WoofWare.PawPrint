...
module TestPureCases =
    ...
    let unimplemented =
        [
            ...
            "NullDereferenceTest.cs" // past QCall RuntimeMethodHandle::IsCAVisibleFromDecoratedType; now blocked by unimplemented QCall CustomAttribute_CreateCustomAttributeInstance during reflection-based CA construction in the ArgumentException ctor / ResourceManager init path
            "MakeGenericTypeStructConstraint.cs" // past QCall RuntimeMethodHandle::IsCAVisibleFromDecoratedType; now blocked by unimplemented QCall CustomAttribute_CreateCustomAttributeInstance during reflection-based CA construction in the ArgumentException ctor / ResourceManager init path
            "MakeGenericTypeClassConstraint.cs" // past QCall RuntimeMethodHandle::IsCAVisibleFromDecoratedType; now blocked by unimplemented QCall CustomAttribute_CreateCustomAttributeInstance during reflection-based CA construction in the ArgumentException ctor / ResourceManager init path
            "MakeGenericTypeNewConstraint.cs" // past QCall RuntimeMethodHandle::IsCAVisibleFromDecoratedType; now blocked by unimplemented QCall CustomAttribute_CreateCustomAttributeInstance during reflection-based CA construction in the ArgumentException ctor / ResourceManager init path
            "ArithmeticOperations.cs" // Add_ovf/Mul_ovf/Div now raise managed OverflowException via raiseRuntimeException; past QCall RuntimeMethodHandle::IsCAVisibleFromDecoratedType; now blocked by unimplemented QCall CustomAttribute_CreateCustomAttributeInstance during reflection-based CA construction in the OverflowException ctor / ResourceManager init path
