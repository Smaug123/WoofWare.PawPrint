...
module TestPureCases =
    ...
    let unimplemented =
        [
            ...
            "GenericArrayCollapse1.cs" // resolveTypeFromDefn GenericInstantiation round-trip collapses array element types
            "GenericArrayCollapse2.cs" // Stelem TypeSpec round-trip collapses array element types
            "GenericArrayCollapse3.cs" // resolveBaseTypeInfo TypeSpec round-trip collapses array element types
        ]
        |> Set.ofList
