...
module TestPureCases =
    ...
    let unimplemented =
        [
            ...
            "NullDereferenceTest.cs" // past QCall TypeHandle::CanCastTo_NoCacheLookup; now blocked by unimplemented QCall ModuleHandle::ResolveMethod during ArgumentException ctor → ResourceManager init (same blocker as MakeGenericTypeStructConstraint.cs)
