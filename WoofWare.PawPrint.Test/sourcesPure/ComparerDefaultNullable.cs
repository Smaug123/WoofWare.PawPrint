...
// test and yields a `NullableComparer<int>`. Parked on the unimplemented
// `RuntimeTypeHandle_GetGenericTypeDefinition` QCall — see the sibling `ComparerDefault.cs` for
// the three branches that need no reflection beyond what is already modelled.
