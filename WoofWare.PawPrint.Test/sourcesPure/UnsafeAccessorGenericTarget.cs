...
//     from `!0`;
//   * a *method* of a generic type is never reachable from an accessor on a non-generic type; that
//     shape is `sourcesPure/UnsafeAccessorMethodOfGenericType.cs`.
public class TestUnsafeAccessorGenericTarget
{
    ...
    private static int Run()
    {
        ...
        // lookup fails. A comparison that substituted `Boxed<int>`'s instantiation into the
        // candidate would match this and reach the constraint check instead.
        try
        {
