...
module Intrinsics =
    ...
    let call
        ...
        // flag `callMethodWithCommitment` passes straight through: a native QCall frame such as
        // `RuntimeMethodHandle.InvokeMethod` reflecting onto the intrinsic, or the struct-marshal
        // stub calling its date marshaller.
