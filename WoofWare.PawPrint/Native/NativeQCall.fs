...
module NativeQCall =
    let private handlers : Map<string, NativeCallContext -> NativeHandlerResult option> =
        [
            ...
            "RuntimeFieldHandle_GetValue", NativeRuntimeFieldHandle.tryExecuteQCall "RuntimeFieldHandle_GetValue"
            ...
            NativeReflectionInvocation.tryExecuteQCall "ReflectionSerialization_GetCreateUninitializedObjectInfo"
            ...
            NativeRuntimeType.tryExecuteQCall "RuntimeTypeHandle_RegisterCollectibleTypeDependency"
            "RuntimeTypeHandle_MakeByRef", NativeRuntimeType.tryExecuteQCall "RuntimeTypeHandle_MakeByRef"
            "RuntimeTypeHandle_MakeSZArray", NativeRuntimeType.tryExecuteQCall "RuntimeTypeHandle_MakeSZArray"
            ...
            "ModuleHandle_GetToken", NativeModuleHandle.tryExecuteQCall "ModuleHandle_GetToken"
